...
argglobal
%argdel
$argadd ed_main/models.py
edit ed_main/models.py
...
wincmd w
argglobal
if bufexists("ed_main/admin_views.py") | buffer ed_main/admin_views.py | else | edit ed_main/admin_views.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 92 + 92) / 185)
tabnext 1
badd +1 ed_main/models.py
badd +0 ed_main/admin_views.py
