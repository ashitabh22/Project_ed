...
argglobal
%argdel
$argadd ed_main/routes.py
edit ed_main/routes.py
...
wincmd w
argglobal
if bufexists("ed_main/models.py") | buffer ed_main/models.py | else | edit ed_main/models.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 104 + 104) / 208)
tabnext 1
badd +0 ed_main/routes.py
badd +0 ed_main/models.py
