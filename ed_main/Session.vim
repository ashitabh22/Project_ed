...
silent only
silent tabonly
cd ~/Documents/ed_project/ed_main
...
exe 'vert 2resize ' . ((&columns * 153 + 92) / 185)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
normal! 026|
tabnext
edit templates/question_viewer.html
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists("models.py") | buffer models.py | else | edit models.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 17 - ((6 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 24 - ((21 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
badd +2 routes.py
badd +1 __init__.py
badd +16 templates/question_viewer.html
badd +24 models.py
badd +19 forms.py
badd +213 templates/index.html
badd +47 static/js/javascript.js
