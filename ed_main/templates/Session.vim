...
silent only
silent tabonly
cd ~/Documents/ed_project/ed_main/templates
...
argglobal
%argdel
$argadd question_viewer.html
edit question_viewer.html
...
wincmd w
argglobal
if bufexists("~/Documents/ed_project/ed_main/routes.py") | buffer ~/Documents/ed_project/ed_main/routes.py | else | edit ~/Documents/ed_project/ed_main/routes.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 92 + 92) / 185)
tabnext 1
badd +0 question_viewer.html
badd +0 ~/Documents/ed_project/ed_main/routes.py
